...
if 'selected_movie_name' not in st.session_state:
    st.session_state['selected_movie_name'] = "GoodFellas"
...
def main():
    def initial_options():
        ...
        st.session_state.user_menu = streamlit_option_menu.option_menu(
            menu_title='What are you searching for ? ',
            options=['Suggest me a similar movie', 'Describe the movie', 'Browse all Movies'],
            icons=['film', 'film', 'film'],
            menu_icon='list',
            orientation="horizontal",
        )

        if st.session_state.user_menu == 'Suggest me a similar movie':
            recommend_display()
